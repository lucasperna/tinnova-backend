...
public class VeiculoResource {
	...
	public ResponseEntity<List<Object[]>> countDecada() {
		List<Object[]> obj = service.countDecada();
		return ResponseEntity.ok().body(obj);
	}
	
	@RequestMapping(value="/semana", method=RequestMethod.GET)
	public ResponseEntity<List<Veiculo>> findUltimosVeiculos() {
		List<Veiculo> list = service.findUltimosVeiculos();
		return ResponseEntity.ok().body(list);
	}
}
